...
#
# Depends on the clang and llvm-as targets for compiling and
...
function(link_bc)
  ...
  add_custom_command(
    ...
    DEPENDS ${llvm-link_target} ${ARG_INPUTS} ${RSP_FILE}
  )
...
macro(add_libclc_builtin_set arch_suffix)
  ...
  add_custom_command( OUTPUT ${builtins_opt_lib_tgt}.bc
    COMMAND ${opt_exe} ${ARG_OPT_FLAGS} -o ${builtins_opt_lib_tgt}.bc
      ${builtins_link_lib}
    DEPENDS ${opt_target} ${builtins_link_lib}
  )
  ...
  add_custom_command( OUTPUT ${LIBCLC_LIBRARY_OUTPUT_INTDIR}/${obj_suffix}
    ...
    COMMAND ${prepare_builtins_exe} -o ${LIBCLC_LIBRARY_OUTPUT_INTDIR}/${obj_suffix}
      ${builtins_opt_lib}
    DEPENDS ${builtins_opt_lib} ${prepare_builtins_target} )
